package com.teach.android.educationonline.ui;
...
import com.teach.android.educationonline.http.convert.GsonConverterFactory;
import com.teach.android.educationonline.http.core.ApiCookie;
import com.teach.android.educationonline.http.interceptor.HttpLogInterceptor;
import com.teach.android.educationonline.http.loader.LoaderManager;
import com.teach.android.educationonline.log.MyLog;
import com.teach.android.educationonline.log.inner.LogcatTree;
import com.teach.android.educationonline.util.assist.SSLUtil;
...
public class Myapplication extends Application {
    ...
    private void initLog() {
        ...
        MyLog.plant(new LogcatTree());//添加打印日志信息到Logcat的树
    }
    ...
    private void initNet() {
        ...
        ViseHttp.CONFIG()
                //配置请求主机地址
                .baseUrl("http://192.168.1.113//music_live/")
                //配置全局请求头
...
//                .connectionPool(new ConnectionPool())
                //配置主机证书验证
                .hostnameVerifier(new SSLUtil.UnSafeHostnameVerifier("192.168.1.113//music_live/"))
                //配置SSL证书验证
