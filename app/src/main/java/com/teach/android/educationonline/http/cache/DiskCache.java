...
import com.teach.android.educationonline.util.cipher.MD5;
import com.teach.android.educationonline.util.system.AppUtil;
...
public class DiskCache implements ICache{
    ...
    private static long calculateDiskCacheSize(File dir){
        ...
        try{
            ...
            long available = ((long) statFs.getBlockCountLong() * statFs.getBlockSize());
            size = available / 50;
