package com.teach.android.educationonline.util.assist;
...
public class Network {
    ...
    public static boolean printNetworkInfo(Context context) {
        ...
        if (connectivity != null) {
            ...
            MyLog.i("getActiveNetworkInfo: " + in);
            NetworkInfo[] info = connectivity.getAllNetworkInfo();
            if (info != null) {
                for (int i = 0; i < info.length; i++) {
                    // if (info[i].getType() == ConnectivityManager.TYPE_WIFI) {
                    MyLog.i("NetworkInfo[" + i + "]isAvailable : " + info[i].isAvailable());
                    MyLog.i("NetworkInfo[" + i + "]isConnected : " + info[i].isConnected());
                    MyLog.i("NetworkInfo[" + i + "]isConnectedOrConnecting : " + info[i].isConnectedOrConnecting());
                    MyLog.i("NetworkInfo[" + i + "]: " + info[i]);
                    // }
                }
                MyLog.i("\n");
            } else {
                MyLog.i("getAllNetworkInfo is null");
            }
        }
        return false;
    }
    ...
    public static int getConnectedTypeINT(Context context) {
        NetworkInfo net = getConnectivityManager(context).getActiveNetworkInfo();
        if (net != null) {
            MyLog.i("NetworkInfo: " + net.toString());
            return net.getType();
        }
        return -1;
    }
