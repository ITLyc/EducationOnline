package com.teach.android.educationonline.util.view;
...
public class NotificationUtil {
    ...
    public static void notification(Context context, PendingIntent pendingIntent, int id,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            ...
            // 定义Notification的各种属性
            Notification notification = new Notification.Builder(context).setTicker(ticker).setSmallIcon(icon).build();
