...
import com.teach.android.educationonline.util.assist.ShellUtil;
...
public class SilentInstaller {
    ...
    public int installSilent(Context context, String filePath, String pmParams) {
        ...
        MyLog.e(TAG, new StringBuilder().append("installSilent successMsg:").append(commandResult.responseMsg)
                .append(", ErrorMsg:").append(commandResult.errorMsg).toString());
        if (commandResult.errorMsg == null) {
