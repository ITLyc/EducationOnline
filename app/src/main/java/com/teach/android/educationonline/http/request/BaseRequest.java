...
import com.teach.android.educationonline.http.interceptor.HeadersInterceptor;
import com.teach.android.educationonline.http.interceptor.UploadProgressInterceptor;
import com.teach.android.educationonline.http.mode.ApiHost;
import com.teach.android.educationonline.http.mode.HttpHeaders;
    ...
    protected void generateLocalConfig() {
        ...
        if (isHttpCache) {
            try {
                ...
                MyLog.e("Could not create http cache" + e);
            }
